...
const Signup = () => {
  ...
  return stepCounter === 1 ? (
    ...
    >
      ...
      />
      <button onClick={() => setStepCounter(stepCounter + 1)}>Suivant</button>
    </div>
  ) : stepCounter === 2 ? (
    <div
      style={{
    ...
    >
      ...
      />
      <button onClick={() => setStepCounter(stepCounter - 1)}>Précédent</button>
      <button onClick={() => createUser()}>Validez</button>
    </div>
  ) : null;
};
